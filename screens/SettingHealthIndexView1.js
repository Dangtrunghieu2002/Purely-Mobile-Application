...
const SettingHealthIndexView1 = () => {
  ...
  return (
    <View style={styles.settingHealthIndexView}>
      <View style={styles.youChose4IndicatorsParent}>
        ...
        <View style={[styles.celsius1Parent, styles.parentFlexBox]}>
          ...
          <View style={[styles.rectangleWrapper, styles.wrapperSpaceBlock]}>
            <View style={[styles.frameChild, styles.tick1Layout]} />
          </View>
        </View>
        <View style={[styles.celsius1Parent, styles.parentFlexBox]}>
          <Image
      ...
      <View style={styles.settingWhichIndexIsShowParent}>
      ...
      <View style={styles.component38}>
        ...
        <View style={[styles.rectangleParent, styles.childPosition]}>
          <View style={[styles.frameChild5, styles.childPosition]} />
          <Pressable
