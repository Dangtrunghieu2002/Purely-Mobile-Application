...
const NotiConnection = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.notiConnection}>
      <View style={styles.component39}>
        ...
        <View style={[styles.rectangleParent, styles.childPosition]}>
          ...
          <View
            style={[styles.angleRight2Parent, styles.angleRight2ParentLayout]}
          >
            <Image
      ...
      <View style={[styles.frameParent, styles.frameParentPosition]}>
        <View style={styles.allowConnectionNotificationParent}>
          <Text style={[styles.allowConnectionNotification, styles.allFlexBox]}>
            Allow connection notification
          </Text>
          <Image
        ...
        <View
          style={[
            styles.connectionsHealthIndexAlerParent,
            styles.frameChildBorder,
          ]}
        >
          <Text
            style={[
              styles.connectionsHealthIndex,
              styles.connectionsHealthIndexTypo,
            ]}
          >
            Connections’ health index alert
          </Text>
...
const styles = StyleSheet.create({
  ...
  allowConnectionNotificationParent: {
    flexDirection: "row",
  },
  connectionsHealthIndex: {
    alignItems: "center",
    width: 327,
    display: "flex",
    textAlign: "left",
  ...
  connectionsHealthIndexAlerParent: {
