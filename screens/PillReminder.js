...
const PillReminder = () => {
  ...
  return (
    <View style={styles.pillReminder}>
      <View style={[styles.component37Parent, styles.component32Position]}>
        <View style={styles.componentLayout}>
          <View style={[styles.component37Child, styles.childPosition1]} />
          <Text style={[styles.textFill, styles.endDateTypo]}>10/06/2022</Text>
          <Image
        ...
        <View style={[styles.component39, styles.componentLayout]}>
          <View style={[styles.component37Child, styles.childPosition1]} />
          <Text style={[styles.textFill, styles.endDateTypo]}>30 pills</Text>
          <Image
            style={[styles.angleDown2Icon, styles.iconLayout1]}
            resizeMode="cover"
            source={require("../assets/angledown-2.png")}
        ...
        <View style={styles.repeatOnParent}>
          ...
          <View style={styles.instanceParent}>
            <View style={styles.component7Layout}>
              <Image
                style={[styles.instanceInner, styles.childPosition]}
                resizeMode="cover"
        ...
        <View style={styles.endDateParent}>
          ...
          >{`End date: `}</Text>
          <Text style={styles.text11}>14/07/2022</Text>
        </View>
        <View style={[styles.component39, styles.componentLayout]}>
          <View style={[styles.component37Child, styles.childPosition1]} />
          <Text style={[styles.textFill, styles.endDateTypo]}>30 mins</Text>
          <Image
            style={[styles.angleDown2Icon, styles.iconLayout1]}
            resizeMode="cover"
            source={require("../assets/angledown-21.png")}
          />
          <Text style={styles.title}>Notification before</Text>
        </View>
        <View style={[styles.component39, styles.componentLayout]}>
          <View style={[styles.component37Child, styles.childPosition1]} />
