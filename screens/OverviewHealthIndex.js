...
const OverviewHealthIndex = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.overviewHealthIndex}>
      <View style={[styles.hrIndex1Parent, styles.parentPosition1]}>
                ...
                <View>
                  <View>
                    <View style={styles.parentFrameFlexBox}>
                      <Text style={[styles.heartRate, styles.bpmTypo]}>
                        Heart rate
                      </Text>
          ...
          <View style={[styles.heartParent, styles.parentFrameFlexBox]}>
            ...
            <View style={[styles.frameParent, styles.parentFrameFlexBox]}>
              <View>
                <View>
                  <View style={styles.parentFrameFlexBox}>
                    <Text style={[styles.heartRate, styles.bpmTypo]}>SPO2</Text>
        ...
        <View style={[styles.blIndex1, styles.indexShadowBox]}>
        ...
        <View style={[styles.weightIndex2, styles.indexShadowBox]}>
          <View style={[styles.weightParent, styles.parentFrameFlexBox]}>
            <Image
              style={styles.heartIcon}
              resizeMode="cover"
        ...
        <View style={[styles.add2Parent, styles.parentFrameFlexBox]}>
          <Image
      ...
      <Image
        style={[styles.weightIndex3, styles.iconLayout1]}
        resizeMode="cover"
        source={require("../assets/weight-index-3.png")}
      />
      <View style={styles.angleRight2Parent}>
        ...
        <View style={styles.ellipseParent}>
          ...
          />
          <Text style={[styles.text16, styles.textFlexBox1]}>3</Text>
        </View>
        <View style={styles.ellipseParent}>
          <Image
            style={[styles.instanceChild, styles.iconLayout]}
            ...
            source={require("../assets/ellipse-1599.png")}
          />
          <Text style={[styles.text16, styles.textFlexBox1]}>4</Text>
        </View>
        <View style={styles.ellipseParent}>
          <Image
            style={[styles.instanceChild, styles.iconLayout]}
            ...
            source={require("../assets/ellipse-1599.png")}
          />
          <Text style={[styles.text16, styles.textFlexBox1]}>5</Text>
        </View>
        <View style={styles.ellipseParent}>
          <Image
            style={[styles.instanceChild, styles.iconLayout]}
          ...
          />
          <Text style={[styles.text19, styles.textFlexBox1]}>6</Text>
        </View>
        <View style={styles.ellipseParent}>
          <Image
            style={[styles.instanceChild, styles.iconLayout]}
            ...
            source={require("../assets/ellipse-1599.png")}
          />
          <Text style={[styles.text16, styles.textFlexBox1]}>7</Text>
        </View>
        <View style={styles.ellipseParent}>
          <Image
            style={[styles.instanceChild, styles.iconLayout]}
            ...
            source={require("../assets/ellipse-1599.png")}
          />
          <Text style={[styles.text16, styles.textFlexBox1]}>8</Text>
        </View>
        <View style={styles.ellipseParent}>
          <Image
            style={[styles.instanceChild, styles.iconLayout]}
            ...
            source={require("../assets/ellipse-1599.png")}
          />
          <Text style={[styles.text16, styles.textFlexBox1]}>9</Text>
        </View>
        <Image
      ...
      <View style={[styles.component38, styles.rectanglePosition]}>
        ...
        <View style={styles.statusBarwhitebase}>
          ...
          <View style={[styles.charge, styles.gsPosition]}>
            ...
            />
            <Text style={[styles.text23, styles.textFlexBox]}>58 %</Text>
          </View>
          <Image
          ...
          />
          <Text style={[styles.text24, styles.textFlexBox]}>9:41 AM</Text>
          <Image
...
export default OverviewHealthIndex;
