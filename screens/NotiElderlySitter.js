...
const NotiElderlySitter = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.notiElderlySitter}>
      <View style={styles.component39}>
        ...
        <View style={[styles.rectangleParent, styles.childPosition]}>
          ...
          <View style={[styles.angleRight2Parent, styles.thereIsAnLayout]}>
            <Image
              style={[styles.angleRight2Icon, styles.chevronLeftLayout]}
              resizeMode="cover"
              source={require("../assets/angleright-2.png")}
            />
            <Text style={[styles.signUp, styles.text1Typo]}>Eldely Sitter</Text>
          </View>
        </View>
      </View>
      <View style={[styles.frameParent, styles.frameParentPosition]}>
        <View style={styles.allowElderlySitterNotificatParent}>
          <Text style={[styles.allowElderlySitter, styles.allFlexBox]}>
            Allow elderly sitter notifications
          </Text>
          <Image
        ...
        <View
          style={[
            styles.thereIsAnApplicationToYouParent,
            styles.frameChildBorder,
          ]}
        >
          <Text style={[styles.thereIsAn, styles.thereIsAnTypo]}>
            There is an application to your request
          </Text>
...
const styles = StyleSheet.create({
  ...
  allowElderlySitterNotificatParent: {
    flexDirection: "row",
  },
  thereIsAn: {
    alignItems: "center",
  ...
  thereIsAnApplicationToYouParent: {
...
export default NotiElderlySitter;
