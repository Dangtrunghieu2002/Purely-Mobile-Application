...
const OverviewHealthIndex1 = () => {
  ...
  return (
    <View style={styles.overviewHealthIndex}>
      <View style={[styles.blIndex1Parent, styles.parentPosition1]}>
        <Pressable
          style={styles.indexShadowBox}
              ...
              <View>
                <View>
                  ...
                  <View style={[styles.minParent, styles.parentFrameFlexBox]}>
                    <Text style={[styles.min, styles.textLayout]}>Min</Text>
                    <Text style={[styles.average, styles.textLayout]}>
                      Average
                    </Text>
                ...
                <View style={styles.parent}>
                  <Text style={[styles.text, styles.textTypo]}>159/120</Text>
                  <Text style={[styles.text1, styles.textTypo1]}>80/126</Text>
                  <Text style={[styles.text1, styles.textTypo1]}>90/137</Text>
                </View>
              </View>
              <Image
            ...
            <View style={[styles.frameParent, styles.parentFrameFlexBox]}>
              <View>
                <View>
                  ...
                  <View style={styles.parent}>
                    <Text style={[styles.text3, styles.textTypo1]}>80</Text>
                    <Text style={[styles.text1, styles.textTypo1]}>80</Text>
                    <Text style={[styles.text5, styles.textTypo]}>134</Text>
                  </View>
                </View>
              </View>
              <Image
          ...
          <View style={[styles.heartParent, styles.parentFrameFlexBox]}>
            ...
            <View style={[styles.frameParent, styles.parentFrameFlexBox]}>
              <View>
                ...
                <View style={styles.parent}>
                  <Text style={[styles.text3, styles.textTypo1]}>96</Text>
                  <Text style={[styles.text1, styles.textTypo1]}>98</Text>
                  <Text style={[styles.text1, styles.textTypo1]}>99</Text>
                </View>
              </View>
              <Image
                style={[styles.angleRight3Icon, styles.angleIconLayout]}
          ...
          <View style={[styles.weightParent, styles.parentFrameFlexBox]}>
            ...
            <View style={[styles.frameParent6, styles.parentFrameFlexBox]}>
              <View>
                ...
                <View style={styles.parent}>
                  <Text style={[styles.text3, styles.textTypo1]}>45</Text>
                  <Text style={[styles.text1, styles.textTypo1]}>45</Text>
                  <Text style={[styles.text1, styles.textTypo1]}>46</Text>
                </View>
              </View>
              <Image
                style={[styles.angleRight3Icon, styles.angleIconLayout]}
        ...
        <View style={styles.component32}>
          ...
          />
          <Text style={[styles.textField, styles.textTypo1]}>
            Manual measure
          </Text>
        </View>
      </View>
